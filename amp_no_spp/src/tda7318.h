...
/**
 * @brief Відкладене збереження в EEPROM.
 * Викликати з loop(). Зберігає налаштування через 3 с після останньої зміни.
 * НЕ блокує CPU під час регулювання — усуває затикання BT audio.
 */
void tda7318Loop();
